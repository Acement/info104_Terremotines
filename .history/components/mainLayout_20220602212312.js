          ...
          >
            Tablas
                ...
                <FormLabel htmlFor='owner'>Seleccione marcadores</FormLabel>
                  <Button colorScheme="red">Terremotos de Mayor Magnitud registrados</Button>
                  <Button colorScheme="red">Terremotos mas mortales registrados</Button>
                  <Button colorScheme="red">Terremotos con el mayor impacto economico registrados</Button>

          </DrawerBody>

          <DrawerFooter>
            <Button borderRadius={4} variant="outline" mr={3} onClick={onClose}>
              Cancel
            </Button>
