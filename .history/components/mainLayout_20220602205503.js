          ...
          >
            Tablas
                ...
                <FormLabel htmlFor='owner'>Seleccione marcadores</FormLabel>
                  <Button colorScheme="red" variant="outline" mr={4} value='markerD' >Más destructivos</Button>
                  <Button colorScheme="red" variant="outline" mr={4}  value='markerI'>Mayor impacto</Button>
                  <Button colorScheme="red" variant="outline" mr={4}  value='markerM'>Mayor Magnitud </Button>
