          ...
          >
            Tablas
                ...
                <FormLabel htmlFor='owner'>Seleccione marcadores</FormLabel>
                  <Button borderRadius={4} colorScheme="red">Terremotos de Mayor Magnitud registrados</Button>
                  <Button borderRadius={4} colorScheme="red">Terremotos mas mortales registrados</Button>
                  <Button borderRadius={4} colorScheme="red">Terremotos con el mayor impacto economico registrados</Button>
