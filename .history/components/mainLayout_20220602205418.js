          ...
          >
            Tablas
                ...
                <FormLabel htmlFor='owner'>Seleccione marcadores</FormLabel>
                  <Button variant="outline" mr={4} value='markerD' colorScheme={red}>Más destructivos</Button>
                  <Button variant="outline" mr={4}  value='markerI'>Mayor impacto</Button>
                  <Button variant="outline" mr={4}  value='markerM'>Mayor Magnitud </Button>
