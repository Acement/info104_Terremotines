      ...
      >
          ...
          {SelectedMarker &&<InfoWindow 
            ...
            <div>
              ...
              <b>{SelectedMarker.Datos.INFO}</b>
             <Button colorScheme='blue' variant='link' > <a href={SelectedMarker.Datos.LINK} rel="none" target="_blank"> <b>más información</b></a> </Button> 
            </div>
          </InfoWindow>
           }
      </GoogleMap>
